...
<form action="/LoginUserServlet" method="get">
    ...
    <div id="login">
        ...
        <div class="col-md-6 w3_agile_mail_grid iput">
						<span class="input input--ichiro" style="left: 0;">
							<input name="Uname" class="input__field input__field--ichiro" type="text" id="input-25" placeholder=" " required="">
							<label class="input__label input__label--ichiro"  for="input-25">
								<span class="input__label-content input__label-content--ichiro">用户名</span>
							</label>
						</span>
            <span class="input input--ichiro "style="left: 0;">
							<input name="psd" class="input__field input__field--ichiro" type="password" id="input-26" placeholder=" " required="">
            ...
            <div class="">
                <button class="boxtograd" type="submit"  style="text-align: center;" ><p >登录</p></button>
            </div>
            <div><a href="register.jsp" style="color: white;">去注册</a></div>
            ...
            <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                <nav class="cl-effect-5" id="cl-effect-5">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="#" onclick='javascript:alert("请先登录");showLogin();showForbid();void(0);' class="scroll"><span data-hover="个人信息">个人信息</span></a></li>
                        <li><a href="eSelectPostServlet"  class=""><span data-hover="论坛">论坛</span></a></li>
                    </ul>
                </nav>
            </div>
        </nav>
